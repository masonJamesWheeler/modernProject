...
export default function DragandDrop() {
  ...
  return (
    <main class="flex-col min-h-screen items-center justify-center  font-sans py-5 px-5">
      <label for="dropzone-file" class=" h-sm mx-auto cursor-pointer flex w-full max-w-lg flex-col items-center rounded-xl border-2 border-spacing-1 border-violet-500 bg-slate-100 bg-blend-multiply p-6 text-center">
        ...
        <input id="dropzone-file"  onChange={onImageChange}  type="file" accept = "image/png, image/jpg, image/jpeg" class = "hidden"/>
      </label>
      ...
      <div id = "displayImage" class = "w-8/12 block mx-auto py-4">
      <img src={img} alt="" class="self-center rounded-3xl"/>
