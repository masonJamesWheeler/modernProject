...
import Display from "../displays/component"
...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'pick-up', label: 'Pick-Up Available', checked: true },
      { value: 'shipping', label: 'Shipping Available', checked: false },
    ],
  },
  {
    id: 'size',
            ...
            <div className="fixed inset-0 flex z-40">
              ...
              >
                <Dialog.Panel className="ml-auto relative max-w-xs w-full h-full shadow-xl py-4 pb-12 flex flex-col overflow-y-auto">
                  ...
                  {/* Filters */}
                  <form className="mt-4 border-t border-base-300">
                    <h3 className="sr-only">Categories</h3>
                    <ul role="list" className="font-bold  px-2 py-3">
                    ...
                    {filters.map((section) => (
                      <Disclosure as="div" key={section.id} className="border-t border-base-300 px-4 py-6">
                        {({ open }) => (
                          <>
                                ...
                                {section.options.map((option, optionIdx) => (
                                  <div key={option.value} className="flex items-center">
                                    <input
                                      ...
                                      className="h-4 w-4 border-base-300 rounded text-indigo-600 focus:ring-indigo-500"
                                    />
                                    <label
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              ...
              <form className="hidden lg:block">
                ...
                {filters.map((section) => (
                  <Disclosure as="div" key={section.id} className="border-b border-base-300 py-6">
                    {({ open }) => (
                      <>
                            ...
                            {section.options.map((option, optionIdx) => (
                              <div key={option.value} className="flex items-center">
                                <input
                                  ...
                                  type="checkbox"
                                  defaultChecked={option.checked}
                                  className="h-4 w-4 border-base-300 rounded text-indigo-600 focus:ring-red-500 "
                                />
                                <label
